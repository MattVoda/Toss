...
namespace Cogobyte.ProceduralIndicators
{
    ...
    public class ArrowTip : ScriptableObject
    {
        ...
        {
            return arrowTipMode == ArrowTipMode.None || (arrowPath.arrowPathMode != ArrowPath.ArrowPathMode.Extrude && arrowPath.arrowPathMode != ArrowPath.ArrowPathMode.BrokenExtrude);
        }
