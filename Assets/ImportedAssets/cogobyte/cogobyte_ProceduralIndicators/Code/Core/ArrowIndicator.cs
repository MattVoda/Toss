...
namespace Cogobyte.ProceduralIndicators
{
    ...
    [CreateAssetMenu(fileName = "ArrowIndicator", menuName = "Cogobyte/ProceduralIndicators/Arrows/ArrowIndicator", order = 1)]
    [System.Serializable]
    public class ArrowIndicator : SolidMesh
    {
        ...
        public override void generate()
        {
            ...
            else
            {
                ...
                {
                    prepareColorGradient(ref arrowPath.colorFunctions);
